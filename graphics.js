...
const models = openModel('./models/lvl1')
...
function drawScene(gl, programInfo, buffers, texture, deltaTime){
    ...
    var rotx = mat4.rotateX(xrot);
    var rotz = mat4.rotateZ(zrot);
    
    // rotate model
    modelViewMatrix = mat4.multpiply(modelViewMatrix, mat4.translate(x, y, z));
    ...
    normalMatrix = mat4.multpiply(mat4.translate(-x, -y, -z), normalMatrix);
...
function main () {
    ...
    console.log('inint')
    const texture = loadTexture(gl, './sprites/flipped.png');
